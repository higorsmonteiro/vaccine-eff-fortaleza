...
for seed in [2,3,4,5]:
    ...
    # CORONAVAC
    print("CoronaVac")
    os.system(f"python ve_estimate.py --start 2021-01-21 --end 2021-08-31 --vaccine CORONAVAC --seed {seed} --hdi_index 1 --suffix NOVO --dose D1 --days_after 14 --bootstrap_n 1000 --events ALL --t_min 0")
    os.system(f"python ve_estimate.py --start 2021-01-21 --end 2021-08-31 --vaccine CORONAVAC --seed {seed} --hdi_index 1 --suffix NOVO --dose D2 --days_after 14 --bootstrap_n 1000 --events ALL --t_min 0")
    ...
    os.system(f"python ve_estimate.py --start 2021-01-21 --end 2021-08-31 --vaccine CORONAVAC --seed {seed} --hdi_index 1 --suffix NOVO --dose D1 --days_after 7 --bootstrap_n 1000 --events ALL --t_min 0")
    os.system(f"python ve_estimate.py --start 2021-01-21 --end 2021-08-31 --vaccine CORONAVAC --seed {seed} --hdi_index 1 --suffix NOVO --dose D2 --days_after 7 --bootstrap_n 1000 --events ALL --t_min 0")
    ...
    os.system(f"python ve_estimate.py --start 2021-01-21 --end 2021-08-31 --vaccine CORONAVAC --seed {seed} --hdi_index 1 --suffix NOVO --dose D1 --days_after 0 --bootstrap_n 1000 --events ALL --t_min 0")
    os.system(f"python ve_estimate.py --start 2021-01-21 --end 2021-08-31 --vaccine CORONAVAC --seed {seed} --hdi_index 1 --suffix NOVO --dose D2 --days_after 0 --bootstrap_n 1000 --events ALL --t_min 0")
